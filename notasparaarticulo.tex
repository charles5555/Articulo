...
\\
%\textcolor{red}{The last result we want to obtain is the Boltzmann transport equation from the Boltzmann $H$ functional. This procedure is developed in the next subsection.}
