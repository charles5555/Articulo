...
initially out of equilibrium and spatially non-homogeneous. For this, we divided the
system into small cells, so as to conceive a system wherein the local equilibrium
hypothesis is valid for each cell and the global system is not homogeneous. Systems
...
The $H$-functionals $\mathcal{H}'$ and $\mathcal{H}$ correctly recover the most-probable distribution
functions both in out-of-equilibrium states (locally) and when the system is in the global
equilibrium state. This enables the use of all the machinery of thermodynamics, including the
proper definition of state variables for each cell and 
