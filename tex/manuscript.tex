...
\abstract{%
A novel framework is proposed in order to describe the time-evolution of dilute classical
...
of the system follows the relation $dH/dt\leq0$, and the equality condition occurs if the system
...
\acknowledgments{CMP acknowledges Conacyt PhD scholarship.}
...
$\mathcal{H}'$  & Our $H$-functional for a classical dilute gas \\
