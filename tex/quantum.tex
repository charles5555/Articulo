...
this is \commr{[This needs a rationale\dots]}
%
...
is slightly out of equilibrium ---so as to the local equilibrium hypothesis is valid---,
the functional
%
...
satisfies $d\mathcal{H}/dt\leq0$, and the equality condition is attained when the system approaches
the equilibrium state at $t\to\infty$. In Eq.~(\ref{eq:qHfunctTheo}), and for a Fermi (Bose)
