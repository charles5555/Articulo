...
\begin{eqnarray}\label{eq:qHdef}
    ...
    &&\bigg.\pm \Big(1 \mp f_{Mn}(t)) \ln (1 \mp f_{Mn}(t)\Big) \Big]   \delta V_M.
\end{eqnarray}
%
...
is precisely what we call the ``variational entropy'',
...
We rewrite the \textit{variational entropy} (\ref{eq:qHdef}) as
%
\begin{equation}
