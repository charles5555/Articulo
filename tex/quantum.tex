...
The classical $H$-theorem is even to these days one of the pillars on which the classical statistical
physics is founded. Unfortunately, regardless of several attempts that have been made \cite{bib:silva2010,bib:deroeck2006,bib:grabert1974,bib:han2015,bib:das2018,bib:vonneumann2010}, 
...
\cite{bib:tolman}, and subsequently we present the analysis of our proposed $H$-functional.
...
probabilities and the random a priori phases hypotheses were taken as valid. The 
random a priori phases hypothesis can be
...
\end{equation}
%
By means of the above equation, we can recover the distribution function and the entropy of a dilute quantum gas in equilibrium as follows. Setting $\bar\alpha=\mu/kT$ and $\bar\beta=-1/kT$,
...
for every cell in the system. This allows to define non-homogeneous systems,
...
Fermi and Bose gases, through a Taylor series around $\bar f_n g_{nM}=0$ as:
%
...
Succinctly, considering a dilute quantum gas contained in a vessel of volume $V$ (divided into
